...
function Heirarchy() {
  ...
  return (
    ...
    <section className='flex gap-2 '>
      <div className='bg-[#172448] h-[50vh] w-1/2 pl-3 rounded-lg text-white'>
        <p className='font-bold text-2xl text-left py-5 '>Drag & Drop to Restructure</p>
        <p>New Hierarchy</p>
      </div>
      <div className='bg-white flex justify-between w-1/2 px-3 py-5 rounded-lg'>
        <p className='font-bold text-2xl text-left '>Hierarchy View</p>
        <IoScan size={50} />
      </div>
    </section>
