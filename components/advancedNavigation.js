...
const NavPills = () => {
    ...
    return ( 
        ...
        <Link href="/admin/advanced" className={`${pathname === '/admin/advanced' ? 'bg-blue-theme text-white' : 'bg-white text-blue-theme'} w-28 rounded-full border-blue-theme border-[1px] px-2 py-1 text-center`}>Overview</Link>
