...
import Form from '@/components/leads/leadform';
...
function LeadForm() {
  return (
    <main className='bg-[#C7C7C7] rounded-lg mx-5 px-3 py-3'>
        ...
        <section className='rounded-lg flex flex-col md:flex-row gap-2 my-4 min-h-[90vh]'>
            <div className='overflow-x-auto w-full md:w-1/2 min-h-[80vh] rounded-md'>
                <table className='w-full min-h-[80vh] bg-[#172448] '>
            ...
            <div className='w-full md:w-1/2'>
              {/* <Form/> */}
              <iframe src="https://kazidesk.com/lead-form/625a37b9dfbe24e147afb4a51c1c95aa" frameborder="0" scrolling="yes"  className='w-full h-[80vh] rounded-md '></iframe>
            </div>
    </section>
