...
import TicketLowerPills from "./ticketLowerNav";
const TicketTabs = () => {

    const [activeItem, setActiveItem] = useState('Type Wise Tickets');
    const navItems = ['Type Wise Ticket', 'Status Wise Ticket', 'Channel Wise Ticket ', 'Open Tickets'];
