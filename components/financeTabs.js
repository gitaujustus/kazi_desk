...
import FinanceLowerPills from "./financeLowerNav";
const FinanceTabs = () => {

    const [activeItem, setActiveItem] = useState('Invoice Overview');
    const navItems = ['Invoice Overview', 'Estimate Overview', 'Proposal Overview', 'Client Wise Earnings', 'Earnings By Projects'];
